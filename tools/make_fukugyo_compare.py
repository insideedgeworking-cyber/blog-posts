...
make_table("fukugyo-reality.png", "副業で稼げている人の割合（“続けている人”ベース・ピンキリ）",
    ["副業", "稼げている割合の現実", "100人いたら(目安)", "出典"],
    [
        ["副業全体(平均的な実態)", "月1万未満が最多/10万超は約14%", "約48人が月1万未満", "Job総研2025ほか"],
        ["ブログ・アフィリエイト", "大半が月1万未満/100万超も13.3%", "約60人が月1万未満", "アフィリ協会2025"],
        ["YouTube", "収益化到達は上位15〜17%だけ", "15〜17人だけ収益化", "各種統計"],
        ["せどり・物販", "月の利益1万円以下が約63%", "約63人が月1万以下", "実践者調査"],
        ["コンテンツ販売(note)", "月1万超は上位ごく一部", "1万人に1〜2人(会員1000万)", "note公表"],
        ["Webライター・動画編集", "即金で月数万が中心", "多くが月数万円台", "各種相場"],
        ["X・Threads", "広告収益は数百〜数千円が大半", "ほぼ数百〜数千円", "各種"],
    ],
    [0.22, 0.34, 0.26, 0.18],
    "※いずれも“今も続けている人”への調査。始めて数ヶ月でやめた多数は含まれない＝実際の難易度はもっと高い。基準は調査ごとに異なる目安。",
    figh=4.6)
