...
PROFILE = """
<p>はじめまして。<strong>WorkStartEdge｜未経験から始める副業ログ</strong>を運営している管理人です。当ブログを読んでくださり、ありがとうございます。このページでは、私がどんな人間で、どんな思いでこのブログを書いているのかを正直にお伝えします。</p>

<h2>ずっと飲食業で働いてきました</h2>
<p>私はもともと、パソコンもまともに触ったことがないまま、ずっと飲食業で働いてきました。ローマ字入力もおぼつかないレベルで、「CPU」や「グラボ」といった言葉を聞いても、まるで別世界の話のようでした。仕事に大きな不満があったわけではありませんが、「このまま続けても、収入はそんなに変わらないかもしれない」という、ぼんやりとした不安をずっと抱えていました。</p>

<h2>未経験・低スペックPC・スマホから副業を始めました</h2>
<p>そんな私が、AIとゲーム用パソコンをきっかけに副業に興味を持ち、今は<strong>スマホと、GPUも積んでいない古いノートPC</strong>だけで副業に挑戦しています。特別なスキルも、資格も、高性能なパソコンも持っていません。分からないことはその都度AIに聞き、調べ、手を動かしながら、一歩ずつ進めている最中です。</p>
<p>だからこそ当ブログは、「すでに成功した人が上から教える」のではなく、<strong>“今まさに同じ場所でつまずいている人間”が、リアルタイムで記録していく</strong>形にしています。うまくいったことだけでなく、失敗やつまずきも隠さずに書くのは、それが同じ立場の方にいちばん役立つと信じているからです。</p>

<h2>このブログで発信していること</h2>
<p>「副業もPCもやったことがない人」に向けて、私自身が実際に取り組んでいる次のテーマを、初心者向けに分かりやすくまとめています。</p>
<ul>
<li><strong>ブログ・アフィリエイト</strong>（始め方・収益化・SEO・キーワード選定・各種審査）</li>
<li><strong>AIライティング・AI活用</strong>（ChatGPT・Claude・Geminiの使い分け、プロンプト、AIエージェント）</li>
<li><strong>Webライター・スマホ副業</strong>（クラウドソーシング、SNS運用代行、動画編集、ポイ活 など）</li>
<li><strong>SNS集客・YouTube・AI音楽</strong>（X／Threads／Instagramの伸ばし方、動画と音楽での収益化）</li>
<li><strong>初心者向けの用語解説</strong>（PC・副業・SNS・ブログの基本用語をかみ砕いて）</li>
</ul>
<p>ひとつのジャンルに絞らず、複数を組み合わせて稼ぐ方法を、<strong>数字も失敗も正直に</strong>書いていきます。</p>

<h2>記事づくりで大切にしていること</h2>
<p>当ブログの記事は、読者の方に安心して読んでいただけるよう、次の方針で作成しています。</p>
<ul>
<li><strong>一次情報・実体験を最優先</strong>：自分で実際に試したこと、調べて確かめたことをベースに書いています。</li>
<li><strong>AIは“下書きの相棒”、最終的な確認と判断は人間が行う</strong>：効率化のためにAIを活用していますが、事実関係の確認・体験の追記・最終チェックは必ず私自身が行っています。</li>
<li><strong>誇大表現をしない</strong>：「必ず稼げる」のような断定は避け、リスクやデメリットも正直にお伝えします。</li>
<li><strong>情報は更新する</strong>：制度やツールは変化が速いため、古くなった情報は見直すよう努めています。</li>
</ul>

<h2>同じ立場のあなたへ</h2>
<p>「未経験だから」「PCに詳しくないから」と一歩を踏み出せずにいる方に、「それ、始めない理由にはならないよ」と伝えたくてこのブログを書いています。かつての私がそうだったように、最初は誰でも何も分かりません。一緒に、少しずつ前に進んでいきましょう。</p>

<h2>お問い合わせ</h2>
<p>記事に関するご質問・ご感想、その他のご連絡は、<a href="/contact/">お問い合わせページ</a>よりお気軽にお寄せください。いただいた内容は今後の記事づくりの参考にさせていただきます。</p>
"""

if __name__ == "__main__":
    upsert_page("privacy-policy", "プライバシーポリシー", PRIVACY.strip())
    upsert_page("profile", "プロフィール", PROFILE.strip())
    bio = ("飲食業出身。未経験・低スペックPC・スマホからAIを活用して副業に挑戦中の現役プレイヤー。"
           "ブログ/AIライティング/Webライター/SNS/YouTubeを掛け合わせて稼ぐ方法を、"
           "実体験ベースで・数字も失敗も正直に発信。AIは下書きに使い、事実確認と仕上げは必ず自分で行っています。")
